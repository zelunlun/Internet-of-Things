...
char client_id[] = "isu10903103a";

// MQTT topics
#define TOPIC_INFO  "isu10903103a/info"
//#define TOPIC_RangeInInches "isu10903103a/sensor/RangeInInches"
#define TOPIC_RangeInCentimeters   "isu10903103a/sensor/RangeInCentimeters"
#define TOPIC_LED_CONTROL "isu10903103a/control/led"
...
void loop() {
  ...
  if( TEMP_PERIOD < (current_time - temp_last_time) ) {
    ...
    //sprintf(buf,"%s", String((long)RangeInInches, 10).c_str());
    //client.publish(TOPIC_RangeInInches, buf);
    //sprintf(buf,"%s", String((long)TOPIC_RangeInCentimeters, 10).c_str());
    //client.publish(TOPIC_RangeInCentimeters, buf);
